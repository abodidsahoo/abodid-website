...
const serviceFallbacks = [
  ...
  },
  {
    ...
    href: "#enquiry",
    examples: [
      { label: "Invisible Punctum", href: "/research/punctum" },
...
const mixedWorkFallbacks = {
  ...
  punctum: {
    ...
    coverAlt: "Invisible Punctum research project cover",
    href: "/research/punctum",
    workInProgress: true,
    kind: "Research",
  },
...
export async function getHomeNextContent() {
  ...
  return {
    hero: {
      role: contentValue(heroCuration?.content || null, "role") || "Creative Director, Researcher & Photographer based in London.",
      heading: contentValue(heroCuration?.content || null, "heading") || "Creative Director, Researcher & Photographer based in London.",
      lede: contentValue(heroCuration?.content || null, "lede") || "I help people use stories to communicate, educate and bring communities together.",
    },
    selectedWork: buildMixedSelectedWork(projects, films, researchProjects, curations),
    workCollections,
