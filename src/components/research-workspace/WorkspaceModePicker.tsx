...
export default function WorkspaceModePicker() {
    return (
        <section className="rw-mode-picker">
            <a className="rw-mode-card" href="/paper-renamer/renamer">
                <div className="rw-mode-card__icon" aria-hidden="true">
                    <FilePenLine size={20} />
                </div>
                <div className="rw-mode-card__copy">
                    <p className="rw-section-heading__eyebrow">Paper Renamer</p>
            ...
            <a className="rw-mode-card" href="/paper-renamer/insights">
