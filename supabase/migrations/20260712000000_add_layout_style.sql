-- Add layout_style to portfolio_project_revisions
ALTER TABLE public.portfolio_project_revisions
ADD COLUMN IF NOT EXISTS layout_style integer DEFAULT 1;

-- Update the portfolio_save_draft function to save layoutStyle
