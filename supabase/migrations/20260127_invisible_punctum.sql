...
-- Allow Public Read (Unique policy name to avoid conflicts)
create policy "Invisible Punctum Public Read"
on storage.objects for select
to public
using ( bucket_id = 'invisible-punctum-assets' );

-- Allow Anon Uploads (For Audio Inputs)
create policy "Invisible Punctum Anon Upload"
