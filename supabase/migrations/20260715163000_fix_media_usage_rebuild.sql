...
-- Supabase's safe-update guard rejects an unrestricted DELETE, including
-- inside maintenance functions. The explicit primary-key predicate still
-- clears every usage row while satisfying that guard.
