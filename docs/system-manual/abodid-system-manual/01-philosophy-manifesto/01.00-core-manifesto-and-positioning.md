...
flowchart TD
    ...
    subgraph Col1["Spatial Architecture"]
        direction TB
        P1["Exhibition & Spatial Media"] --> E1["Into the Flux (IBA)<br/>Outernet London"]
    end

    subgraph Col2["Digital Systems"]
        direction TB
        P2["Interaction Design & Systems"] --> E2["Punctum Suite & Lab<br/>Obsidian Vault RAG"]
    end

    subgraph Col3["Visual Culture"]
        direction TB
        P3["Narrative Film & Editorial"] --> E3["BFI Campaigns<br/>Documentary Cinema"]
    end
